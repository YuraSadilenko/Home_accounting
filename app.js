...
var budgetController = (function(){
    ...
    return {
        ...
        calculateBudget: function() {
            //1. Calc total income and expences
            calculateTotal('inc');
            calculateTotal('exp');


            //2. Calc total budget: incomes - expences
...
var userController = (function(){
    ...
    var formatNumber = function(num, type) {
        ...
        */      
        ...
        //point at the end of the num
        numSplit = num.split('.');

        //coma seperating thousand
        int = numSplit[0];
        // if( int.length > 3 ){
        //     int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3);//this wiil  put coma at thousand exm: 23,232 ot 123,344 and usual 1,000
        // }
    ...
    return {
        ...
        displayMonth: function() {
            ...
            months = ['January', 'Fabruary', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'Decemer'];
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function() {
        ...
        var percentage = budgetCtrl.getPetcentage();
